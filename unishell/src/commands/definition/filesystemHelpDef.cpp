...
return { .name = FSysCmdCreateFile::symbol, .params = {{"File", {Literal}}}, .description = "creates a file." };
END_HELP

// removeFile
START_HELP(FSysCmdRemoveFile)
return { .name = FSysCmdRemoveFile::symbol, .params = {{"File", {Literal}}}, .description = "remove a file." };
END_HELP

// createDir
START_HELP(FSysCmdCreateDir)
return { .name = FSysCmdCreateDir::symbol, .params = {{"Dir", {Literal}}}, .description = "creates a directory." };
END_HELP

// removeDir
START_HELP(FSysCmdRemoveDir)
return { .name = FSysCmdRemoveDir::symbol, .params = {{"Dir", {Literal}}}, .description = "removes a directory." };
END_HELP
